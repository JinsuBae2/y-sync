...
final commentsProvider =
    FutureProvider.family<List<Comment>, ({CommentSource source, int id})>((
      ref,
      arg,
    ) async {
...
class CommentNotifier {
  ...
  // 💡 관리자용 댓글 삭제 (소프트 딜리트)
  Future<void> deleteCommentByAdmin(
    CommentSource source,
    int id,
    int commentId,
    String reason,
...
final activeParentCommentProvider =
    NotifierProvider<ActiveParentCommentNotifier, Map<int, Comment?>>(
