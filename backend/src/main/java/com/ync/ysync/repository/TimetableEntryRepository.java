...
public interface TimetableEntryRepository extends JpaRepository<TimetableEntry, Long> {
    ...
    // 💡 특정 학년의 시간표 목록 조회
    List<TimetableEntry> findAllByGradeAndClassNumber(Grade grade, int classNumber);
    ...
    @Query("SELECT COUNT(t) > 0 FROM TimetableEntry t " +
           "WHERE t.grade = :grade AND t.classNumber = :classNumber AND t.dayOfWeek = :dayOfWeek " +
