...
#### 12. 가입 인증 증표 (`POST /auth/verify-student/verify-code` → `POST /auth/signup`)
...
#### 13. 공지 알림 수신 학년 (`PUT /members/me/notice-grade`, `PUT /admin/members/{id}`)
...
#### 14. 공지 알림 학년 선택 현황 (`GET /admin/members/notice-grade-stats`)
- **ADMIN / SUPER_ADMIN 전용**
